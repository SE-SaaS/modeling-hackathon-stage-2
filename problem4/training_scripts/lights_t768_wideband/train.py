"""
train.py — experiment: lights_t768_wideband
==========================================
Thin entry point. shared_code does the work; this file only names the
experiment and hands off.

Run locally:  python training_scripts/lights_t768_wideband/train.py
Run on Modal: modal run training_scripts/lights_t768_wideband/train.py
...
try:
    ...
    def modal_main(force: bool = False, fetch_only: bool = False,
        ...
        then syncs /runs/lights_t768_wideband into this folder's results/ dir. See the module
