"""
train.py — experiment: signs_640_aug_y26
=======================================
Thin entry point. shared_code does the work; this file only names the
experiment and hands off.

Run locally:  python training_scripts/signs_640_aug_y26/train.py
Run on Modal: modal run training_scripts/signs_640_aug_y26/train.py
...
try:
    ...
    def modal_main(force: bool = False, fetch_only: bool = False,
        ...
        then syncs /runs/signs_640_aug_y26 into this folder's results/ dir. See the module
