"""
train.py — experiment: signs_640_aug
===================================
Thin entry point. shared_code does the work; this file only names the
experiment and hands off.

Run locally:  python training_scripts/signs_640_aug/train.py
Run on Modal: modal run training_scripts/signs_640_aug/train.py
...
try:
    ...
    def modal_main(force: bool = False, fetch_only: bool = False,
        ...
        then syncs /runs/signs_640_aug into this folder's results/ dir. See the module
