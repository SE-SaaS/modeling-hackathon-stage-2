...
app = modal.App("problem3-dl-marbert-kfold")
...
def train_and_predict_marbert(train_csv_bytes: bytes, test_csv_bytes: bytes):
    import logging
    import pandas as pd
    import numpy as np
    import torch
    ...
    logging.info("Ensembling logits from all 5 MARBERTv2 folds...")
...
def main():
    ...
    output_path = os.path.join(base_dir, 'output', 'submission_dl_modal_marbert.csv')
    ...
    print("Uploading data and starting MARBERTv2 5-Fold Ensembling on Modal GPU...")
    print("This will take approximately 40 minutes. Check your Modal dashboard for real-time logs!")
    
    result_bytes = train_and_predict_marbert.remote(train_bytes, test_bytes)
